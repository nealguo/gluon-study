...
if __name__ == '__main__':
    ...
    for i, colormap in enumerate(VOC_COLORMAP): colormap2label[
    ...
    util.show_images(imgs[::2] + imgs[1::2], 2, n)
    util.plt.show()
    ...
    test_iter = gluon.data.DataLoader(voc_test, batch_size, last_batch='discard', num_workers=num_workers)
